...
// Configuration for Tizen 5.5 Stability
let numImageWorkers = 0;
...
Config.rendererOptions = {
  ...
  textureMemory: {
    criticalThreshold: 40e6 // Lowered for Tizen 5.5 memory constraints
  },
  numImageWorkers,
  deviceLogicalPixelRatio,
  devicePhysicalPixelRatio: 1,
  createImageBitmapSupport: false, // Changed from string "false" to boolean false
  targetFPS: 60
};
...
render(() => {
  // Watchdog: Handle WebGL context loss common on older Samsung TVs
  createEffect(() => {
    ...
    if (canvasElement) {
      canvasElement.addEventListener(
        ...
        (e) => {
          e.preventDefault();
          console.warn(
            "WebGL Context Lost - Hardware failure detected. Reloading..."
          );
